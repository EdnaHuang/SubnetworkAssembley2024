...
save.image(file = here("output", "2023-03-21_P15_VGAT_SYT2_20230318_somatic_input.RData"))
load(here("output", "2023-03-21_P15_VGAT_SYT2_20230318_somatic_input.RData"))
