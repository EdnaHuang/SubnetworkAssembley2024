...
rv_list = c("density_number_100_um_3_vgat_number", 
            ...
            "density_of_colocalized_0_25_microm_number_100_um_3_vgat_number",
            "density_of_colocalized_0_25_microm_number_100_um_3_syt2_number",
...
#no error message--but still apply the model_select function
...
save.image(file = here("output", "2023-03-19_P15_VGAT_SYT2_20230318.RData"))
#load(here("output", "2023-03-19_P15_VGAT_SYT2_20230318.RData"))
