...
# import data
df = read_xlsx(
  here("data", "Neurobiotin_Dendrite_FGFR-tri-Ncre_all_age_20230802.xlsx"),
  sheet = "Multilevel")
...
rv_list = c("min_dendrite_length", "max_dendrite_length","mean","total_length" ,
            "branch_pts","segment_number", "terminal_pts",
            "max_of_18_continous_bin","rest_of_18_continous_bin",
            "count_of_max_of_18_continous_bin","rest_of_18_continous_bin", "polar_ratio")
rv_list = tolower(rv_list)


cv_list= c("group","cell_id_7","sex","f_age")
...
summary(df_lite$total_length)
summary(df_lite$terminal_pts )
...
save.image(file = here("output", "2023-08-02_Neurobiotin_Dendrite_FGFR-tri-Ncre_all_age_20230802.RData"))
