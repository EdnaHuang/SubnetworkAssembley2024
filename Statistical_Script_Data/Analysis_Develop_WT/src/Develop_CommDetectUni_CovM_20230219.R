...
# import data
df = read_xlsx(
  here("data", "SummaryDevAll_CommDetecUni_CovM_withCorrl_20230113.xlsx"),
  sheet = "ForMultilevel")
...
rv_list = c("silhs_mean_before_Stat","n_cls","No_assemblies", "S_assemblies", 
            ...
            "R_ZF_allpair_mean", "Cluster_R_ZF_all_mean")
...
save.image(file = here("output", "2023-02-19_SummaryDevAll_CommDetecUni_CovM_withCorrl_20230113.RData"))
