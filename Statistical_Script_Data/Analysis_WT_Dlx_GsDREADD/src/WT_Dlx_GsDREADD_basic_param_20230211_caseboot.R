...
# import data
df = read_xlsx(
  here("data", "SummaryWT_Dlx_GsDREADD_basicParameter_MeanVersion_withCorre_20230113.xlsx"),
  sheet = "P15 only CNO")
...
save.image(file = here("output", 
                       "2023-02-17_Caseboot_SummaryWT_Dlx_GsDREADD_basicPara_20230113.RData"))