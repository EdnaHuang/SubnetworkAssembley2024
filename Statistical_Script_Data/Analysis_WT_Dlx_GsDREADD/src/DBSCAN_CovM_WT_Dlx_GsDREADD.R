#' ---
#' title: P15 neuronal subnetwork assembly"
...
# import data
df = read_xlsx(
  here("data", "DBSCAN_CovM_SummaryDlxGsDREADD_CorrDistanceArea.xlsx"),
  sheet = "Sheet1")
...
save.image(file = here("output", "DBSCAN_CovM_SummaryWT_Dlx_GsDREADD.RData"))
