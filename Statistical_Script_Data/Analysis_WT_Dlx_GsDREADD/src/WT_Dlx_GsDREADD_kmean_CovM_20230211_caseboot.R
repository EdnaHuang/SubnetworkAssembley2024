#' ---
#' title: "Sex modulated neuronal subnetwork assembly"
...
# import data
df = read_xlsx(
  here("data", "SummaryWT_Dlx_GsDREADD_kmean_CovM_withCorr_Dist_20230113.xlsx"),
  sheet = "P15 only")
...
rv_list = c("silhs_mean_before_stat", "n_cls",
            "cells_not_in_assembly", "cells_in_one_assembly","cells_in_many_assembly",
            "r_allpair_mean", "cluster_r_all_mean","r_zf_allpair_mean" , "cluster_r_zf_all_mean",
...
save.image(file = here("output", "2023-02-17_Caseboot_SummaryWT_Dlx_GsDREADD_kmean_CovM_20230113.RData"))
